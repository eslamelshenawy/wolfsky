...
<!--  -->
<?php echo $__env->make('frontEnd.login_and_register', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<script>
...
$(document).ready(function(){
  $("#book").click(function(){
            ...
            console.log(data);
            $.ajax({
                url: '<?php echo e(url('/book_airport')); ?>',
                data: data,
                type: 'post',
                success: function (data) {
                  console.log(data);
...
$(document).ready(function(){
  $("#hotel_b").click(function(){
            ...
            console.log(data);
            $.ajax({
                url: '<?php echo e(url('/book_airport_h')); ?>',
                data: data,
                type: 'post',
                success: function (data) {
                  console.log(data);
