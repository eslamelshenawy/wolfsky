                                                ...
                                                @foreach($Topic->relatedTopics as $relatedTopic)
                                                    ...
                                                    if ($relatedTopic->topic->$slug_var != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                                        if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                                            ...
                                                            $topic_link_url = url(App::getLocale() . "/" . $relatedTopic->topic->$slug_var);
                                                        } else {
                                                            $topic_link_url = url($relatedTopic->topic->$slug_var);
                                                        }
                                                    } else {
                                                        if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                                            $topic_link_url = route('FrontendTopicByLang', ["lang" => App::getLocale(), "section" => $relatedTopic->topic->webmasterSection->name, "id" => $relatedTopic->topic->id]);
                                                        } else {
