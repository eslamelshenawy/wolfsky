                                ...
                                @foreach($Topics as $Topic)
                                    ...
                                    if ($Topic->$slug_var != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                        if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                            $topic_link_url = url(App::getLocale() . "/" . $Topic->$slug_var);
                                        } else {
                                            $topic_link_url = url($Topic->$slug_var);
                                        }
                                    } else {
                                        if (App::getLocale() != env('DEFAULT_LANGUAGE')) {
                                            $topic_link_url = route('FrontendTopicByLang', ["lang" => App::getLocale(), "section" => $Topic->webmasterSection->name, "id" => $Topic->id]);
                                        } else {
