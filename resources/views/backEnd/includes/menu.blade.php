        ...
        <div flex class="hide-scroll">
            <nav class="scroll nav-active-primary">
                ...
                <ul class="nav" ui-nav>
                   ...
                   <!-- <li> <a href="{{ route('settings') }}" onclick="location.href='{{ route('settings') }}'"> <span class="nav-text">{{ trans('backLang.generalSettings') }}</span> </a> </li> -->

                   <li>
                    <a href="{{url('/')}}/webmaster/translations">
...
<i class="material-icons">&#xe7ef;</i>
                  ...
                  <span class="nav-caret">
                    ...
                    <i class="material-icons">{!! $LiIcon !!}</i>
                                    ...
                                    <ul class="nav-sub">
                                        @if($GeneralWebmasterSection->hotel_air_status == 0)
                                        @if($GeneralWebmasterSection->sections_status > 0)
                                        ...
                                        @endif
                                          ...
                                          @if($GeneralWebmasterSection->hotel_air_status == 1)

                                              <li>
                                                <a href="{{url('/')}}/20/topics">
                                                    <span class="nav-text">{{ trans('backLang.new_book') }}</span>
                                                </a>
                                            </li>

                                            <li class=""> <a href="{{url('/')}}/19/topics">
                                                 <span class="nav-text">{{ trans('backLang.agree') }}</span> </a>
                                             </li>

                                              <li>
                                                <a href="{{url('/')}}/21/topics">
                                                    <span class="nav-text">{{ trans('backLang.notagree') }}</span>
                                                </a>
                                            </li>


                                        @endif
                                          @if($GeneralWebmasterSection->hotel_air_status == 2)

                                              <li>
                                                <a href="{{url('/')}}/22/topics">
                                                    <span class="nav-text">{{ trans('backLang.new_book') }}</span>
                                                </a>
                                            </li>

                                            <li class=""> <a href="{{url('/')}}/24/topics">
                                                 <span class="nav-text">{{ trans('backLang.agree') }}</span> </a>
                                             </li>

                                              <li>
                                                <a href="{{url('/')}}/25/topics">
                                                    <span class="nav-text">{{ trans('backLang.notagree') }}</span>
                                                </a>
                                            </li>
                                        ...
                                        @endif
                                          @if($GeneralWebmasterSection->hotel_air_status == 3)

                                              <li>
                                                <a href="{{url('/')}}/23/topics">
                                                    <span class="nav-text">{{ trans('backLang.new_book') }}</span>
                                                </a>
                                            </li>

                                            <li class=""> <a href="{{url('/')}}/26/topics">
                                                 <span class="nav-text">{{ trans('backLang.agree') }}</span> </a>
                                             </li>

                                              <li>
                                                <a href="{{url('/')}}/27/topics">
                                                    <span class="nav-text">{{ trans('backLang.notagree') }}</span>
                                                </a>
                                            </li>
...
<i class="material-icons">&#xe433;</i>
                  ...
                  <span class="nav-icon">
                    <i class="material-icons"></i>
                                        ...
                                        <span class="nav-text">{{ trans('backLang.about_us') }}</span>
                                    </a>
                    </li> -->
