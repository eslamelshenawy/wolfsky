    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group row">
                    <label for="add_status1" class="col-sm-2 form-control-label">{!!  trans('backLang.add_Banner') !!} </label>
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                <input id="add_Banner" class="has-value"  name="add_Banner" type="radio" value="1"{{$Permissions->add_Banner =='1' ?'checked' : '' }}>
                                <i class="dark-white"></i>
                                نعم
                            </label>
                            <br>
                            <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                <input id="add_Banner2" class="has-value" name="add_Banner" type="radio" value="0"{{$Permissions->add_Banner =='0' ?'checked' : '' }}>
                                <i class="dark-white"></i>
                                لا
                            </label>
                        </div>
