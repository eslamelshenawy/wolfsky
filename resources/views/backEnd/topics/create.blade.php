    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                ...
                @endif
                 ...
                 <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="Name_country_en" required="" dir="ltr" name="Name_country_en" type="text" value="">
                        </div>
                    </div>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="Name_country_ar" required="" dir="ltr" name="Name_country_ar" type="text" value="">
                        </div>
                    </div> 
                        ...
                        <label for="title_en" class="col-sm-2 form-control-label">{!!  trans('backLang.Name_city') !!} 
                            <small>[ English ]</small>                        </label>
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="Name_city_en" required="" dir="ltr" name="Name_city_en" type="text" value="">
                        </div>
                    </div>    
                      <div class="form-group row">
                        <label for="title_en" class="col-sm-2 form-control-label">{!!  trans('backLang.Name_city') !!} 
                            <small>[ العربية ]</small>                        </label>
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="Name_city_ar" required="" dir="ltr" name="Name_city_ar" type="text" value="">
                        </div>
                    </div>
                @endif
                ...
                @if($WebmasterSection->longtext_status)
                    ...
                    @else
                        ...
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="number_hotel" required="" dir="rtl" name="number_hotel" type="number" value="">
                        </div>
                    </div>
                        @endif
         ...
         <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="price" required="" dir="rtl" name="price" type="number" value="">
                        </div>
                    </div>
         ...
         <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="day" required="" dir="rtl" name="day" type="text" value="">
                        </div>
                    </div>
         ...
         <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="night" required="" dir="rtl" name="night" type="text" value="">
                        </div>
                    </div>
