...
@section('headerInclude')
    <link href="{{ URL::to('public/backEnd/libs/js/iconpicker/fontawesome-iconpicker.min.css') }}" rel="stylesheet">
    <!--[if lt IE 9]>
            ...
            <div class="tab-content clear b-t">
                ...
                icons: {
                  ...
                  <span class="fa fa-calendar"></span>
                     ...
                     @if($WebmasterSection->cit_countries_status==1) 


                 <div class="form-group row">
                        <label for="title_en" class="col-sm-2 form-control-label">{!!  trans('backLang.Name_country') !!} 
                            <small>[ English ]</small>                        </label>
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="Name_country_en" required="" dir="ltr" name="Name_country_en" type="text" value="{{$Topics->country->title_en}}">
                        </div>
                    </div>

                       <div class="form-group row">
                        <label for="Name_country_ar" class="col-sm-2 form-control-label">{!!  trans('backLang.Name_country') !!} 
                            <small>[ العربية ]</small>                        </label>
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="Name_country_ar" required="" dir="ltr" name="Name_country_ar" type="text" value="{{$Topics->country->title_ar}}">
                        </div>
                    </div> 
                         @foreach($Topics->country->city as  $city) 
                         <div class="form-group row">
                        <label for="title_en" class="col-sm-2 form-control-label">{!!  trans('backLang.Name_city') !!} 
                            <small>[ English ]</small>                        </label>
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="Name_city_en" required="" dir="ltr" name="Name_city_en" type="text" value="{{$city->title_en}}">
                        </div>
                    </div>    
                      <div class="form-group row">
                        <label for="title_en" class="col-sm-2 form-control-label">{!!  trans('backLang.Name_city') !!} 
                            <small>[ العربية ]</small>                        </label>
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="Name_city_ar" required="" dir="ltr" name="Name_city_ar" type="text" value="{{$city->title_ar}}">
                        </div>
                    </div>
                    @endforeach
                @endif
                        ...
                        @if($WebmasterSection->longtext_status)
                          ...
                          @if($WebmasterSection->cout_hotel ==1)

                            <div class="form-group row">
                        <label for="price" class="col-sm-2 form-control-label"> {!!  trans('backLang.number_hotel') !!}
                                                   </label>
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="number_hotel" required="" dir="rtl" name="number_hotel" type="number" value="{{$Topics->number_hotel}}">
                        </div>
                    </div>
                        @endif
                                @if(Helper::GeneralWebmasterSettings("en_box_status"))
                            ...
                            @endif
                        @endif
                                @if($WebmasterSection->price_status ==1)
                
         <div class="form-group row">
                        <label for="price" class="col-sm-2 form-control-label"> {!!  trans('backLang.price') !!}
                                                   </label>
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="price" required="" dir="rtl" name="price" type="number" value="{{$Topics->price}}">
                        </div>
                    </div>

              @endif
                @if($WebmasterSection->day_status ==1)

         <div class="form-group row">
                        <label for="day" class="col-sm-2 form-control-label"> {!!  trans('backLang.day') !!}
                                                   </label>
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="day" required="" dir="rtl" name="day" type="text" value="{{$Topics->day}}">
                        </div>
                    </div>

              @endif
               @if($WebmasterSection->night_status ==1)

         <div class="form-group row">
                        <label for="night" class="col-sm-2 form-control-label"> {!!  trans('backLang.night') !!}
                                                   </label>
                        <div class="col-sm-10">
                            <input placeholder="" class="form-control" id="night" required="" dir="rtl" name="night" type="text" value="{{$Topics->night}}">
                        </div>
                    </div>
              ...
              @endif
                ...
                @if($WebmasterSection->appear_place ==1)
                            <div class="form-group row">
                            <label for="link_status" class="col-sm-2 form-control-label">
                            {!! trans('backLang.place_pan') !!}
                            </label>
                                    <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        <input id="status1" class="has-value"  name="place_pan" type="radio" value="1" {{$Topics->place_pan == 1 ? 'checked' : ''}}>
                                        <i class="dark-white"></i>
                                        {!! trans('backLang.place_header') !!}
                                    </label>
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        <input id="status2" class="has-value" name="place_pan" type="radio" value="2"{{$Topics->place_pan == 2 ? 'checked' : ''}}>
                                        <i class="dark-white"></i>
                                     {!! trans('backLang.place_center') !!}                                   
                                       </label>
                                      <label class="ui-check ui-check-md">
                                        <input id="status2" class="has-value" name="place_pan" type="radio" value="3"{{$Topics->place_pan == 3 ? 'checked' : ''}}>
                                        <i class="dark-white"></i>
                                        {!! trans('backLang.place_footer') !!}
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <div class="dz-message" ui-jp="dropzone"
                                     ui-options="{ url: '{{ URL::to('public/backEnd/api/dropzone') }}' }">
                                                        ...
                                                        @foreach($Topics->maps as $map)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <img src="{{ URL::to('public/backEnd/assets/images/marker_').$map->icon.".png" }}"
                                                                         style="width: 20px;">
                                                                    @if($title !="")
                                                                        <small>{!! $title !!}</small>
                                                                    @else
...
@section('footerInclude')
    ...
    @if($WebmasterSection->maps_status)
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var iconURLPrefix = "{{ URL::to('public/backEnd/assets/images/')."/" }}";
                var icons = [
    ...
    @endif
    <script src="{{ URL::to('public/backEnd/libs/js/iconpicker/fontawesome-iconpicker.js') }}"></script>
    <script>
        $(function () {
