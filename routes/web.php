...
Auth::routes();
    ...
    Route::POST('log','Auth\LoginController@doLogin');
    Route::POST('reg','Auth\LoginController@doreg');
    Route::POST('book_airport','Airport@dobook');
    Route::POST('book_airport_h','Airport@dobook_h');
    Route::POST('book_hotel','Airport@dobook_hotel');
    Route::POST('book_hote','Airport@dobook_hot');
    Route::POST('add_travel','Airport@add_travel');
    Route::POST('add_class','Airport@add_class');
    Route::get('books','books@books');
    Route::get('about','books@about');
    Route::post('agree/{id}','TopicsController@agreebooks');
    Route::post('not/agree/{id}','TopicsController@notagreebooks');
    Route::post('agree/hotel/{id}','TopicsController@agreebooks_ho');
    Route::post('not/agree/hotel/{id}','TopicsController@notagreebooks_ho');
