...
class TopicsController extends Controller
{
    ...
    public function index($webmasterId)
    {
        ...
        if($webmasterId == 20){
        $air_hote_new=\App\Airportbook::where('agree_status',0)->where('not_agree_status',0)->orderby('id','asc')->paginate(10);
        $air_hote_agree="";
        $air_hote_not_agree="";
        $hote_new="";
        $hote_new_airport="";
        ...
        if($webmasterId == 19){
        $air_hote_agree=\App\Airportbook::where('agree_status',1)->orderby('id','asc')->paginate(10);
        $air_hote_new="";
        $air_hote_not_agree="";
        $hote_agree="";
        $hote_new="";
        ...
        if($webmasterId == 21){
        $air_hote_not_agree=\App\Airportbook::where('not_agree_status',1)->orderby('id','asc')->paginate(10);
        // dd($air_hote_not_agree);
        $air_hote_agree="";
        $air_hote_new="";
        $hote_agree="";
        $hote_new="";
        ...
        if($webmasterId == 22){
        $hote_new=\App\Hotel::where('not_agree_status',1)->where('agree_status','=',0)->orderby('id','asc')->paginate(10);
        $air_hote_agree="";
        $air_hote_not_agree="";
        $air_hote_new="";
        $hote_new_airport="";
        ...
        if($webmasterId == 23){
        $hote_new_airport=\App\Hotel::where('not_agree_status',1)->where('agree_status','=',0)->orderby('id','asc')->paginate(10);
        // dd($hote_new_airport);
        $air_hote_agree="";
        $air_hote_not_agree="";
        $air_hote_new="";
      ...
      //hotel
        if($webmasterId == 24){
        $hote_agree=\App\Hotel::where('agree_status',1)->orderby('id','asc')->paginate(10);
        // dd($hote_new_airport);
        $air_hote_not_agree="";
        $air_hote_new="";
        $hote_new="";
        ...
        if($webmasterId == 25){
        $hote_not_agree_hotel=\App\Hotel::where('not_agree_status',1)->orderby('id','asc')->paginate(10);
        // dd($hote_not_agree_hotel);
        $air_hote_agree="";
        $air_hote_not_agree="";
        $hote_agree="";
        $hote_new_airport="";
...
array_push($a,$WebmasterSection);
        ...
        if (count($a) > 0) {
            ...
            return view("backEnd.topics", compact("Topics","hote_not_agree_hotel", "GeneralWebmasterSections","air_hote_new","hote_agree", "air_hote_agree", 'hote_new', 'hote_new_airport',"air_hote_not_agree", "WebmasterSection"));
        } else {
...
array_push($a,$WebmasterSection);
    ...
    //
            ...
            if (@$request->day != "") {
                $Topic->day = $request->day;
            }
            if (@$request->night != "") {
                $Topic->night = $request->night;
            }
            if ($fileFinalName != "") {
            ...
            $Topic->seo_description_en = mb_substr(strip_tags(stripslashes($request->details_en)), 0, 165, 'UTF-8');
              ...
              if (@$request->Name_country_ar != "") {
                $country=new Country;
                $country->title_ar = $request->Name_country_ar;
                $country->title_en = $request->Name_country_en;
                $country->save();
            }
            if (@$request->Name_city_en != "") {
                $city=new City;
                $city->title_ar = $request->Name_city_ar;
                $city->title_en = $request->Name_city_en;
                $city->country_id = $country->id;
                $city->save();
            $Topic->number_hotel = $request->number_hotel;
            $Topic->country_id = $country->id;
            }
...
array_push($a,$Topic);
            ...
            if (count($a) > 0) {
                ...
                if ($request->status_appear != "") {
                    $Topic->status_appear = $request->status_appear;
                }
                ...
                if (@$request->Name_country_ar != "") {
                $country= Country::find($Topic->country_id);
                $country->title_ar = $request->Name_country_ar;
                $country->title_en = $request->Name_country_en;
                $country->save();
            }
            if (@$request->Name_city_en != "") {
                ...
                $city_edit=City::find($value->id);
                $city_edit->title_ar = $request->Name_city_ar;
                $city_edit->title_en = $request->Name_city_en;
                $city_edit->save();
                }

            }
            if (@$request->number_hotel != "") {
                $Topic->number_hotel = $request->number_hotel;

            }

            // $Topic->country_id = $country->id;
            if (@$request->place_pan != "") {
                $Topic->place_pan = $request->place_pan;
...
<i class=\"dark-white\"></i> &nbsp;<label for=\"related_topics_$i\">$title</label>
    ...
    public function agreebooks(Request $request,$id)
    {
       $airport=Airportbook::find($id);
        $airport->agree_status='1';
        $airport->save();
        return response()->json(['success'=>'تم قبول الطلب ']);

    }

      public function agreebooks_ho(Request $request,$id)
    {
       $airport=Hotel::find($id);
        $airport->agree_status='1';
        $airport->save();
        return response()->json(['success'=>'تم قبول الطلب ']);
       ...
       public function notagreebooks(Request $request,$id)
    {
       $airport=Airportbook::find($id);
        $airport->not_agree_status='1';
        $airport->save();
        return response()->json(['success'=>'تم رفض الطلب ']);

    }
        public function notagreebooks_ho(Request $request,$id)
    {
       $airport=Hotel::find($id);
        $airport->not_agree_status='1';
        $airport->save();
