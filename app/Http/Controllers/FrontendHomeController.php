...
$bestview=Topic::where('webmaster_id',13)->where('status',1)->where('status_appear',1)->orderby('id', 'asc')->paginate(4);
$hotels=Topic::where('webmaster_id',14)->where('status',1)->where('status_appear',1)->orderby('id', 'asc')->paginate(4);
$banner =Topic::where('webmaster_id',29)->where('status',1)->get();
$banner_header =Topic::where('webmaster_id',31)->where('status',1)->where('place_pan',1)->get();
$banner_center =Topic::where('webmaster_id',31)->where('status',1)->where('place_pan',2)->get();
$banner_footer =Topic::where('webmaster_id',31)->where('status',1)->where('place_pan',3)->get();
...
// dd($social);
        ...
        $a=array();
array_push($a,$FooterMenuLinks_father);
...
array_push($a,$Topic);
        ...
        if (count($a) > 0 && ($Topic->expire_date == '' || ($Topic->expire_date != '' && $Topic->expire_date >= date("Y-m-d")))) {
